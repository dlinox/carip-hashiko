<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tipo de Producto</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="card-tools">
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-sm btn-warning">
                                        <input class="crear" type="radio" name="options" id="option1" title="Registrar Tipo de Producto" href="<?= base_url() ?>configuracion/tipo_producto_crear">
