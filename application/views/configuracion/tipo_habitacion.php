<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tipo de Habitacion</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="">Configuracion</a> </li>
                        <li class="breadcrumb-item active">Tipo de Habitacion</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="card-tools">
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-sm btn-warning">
                                        <input class="crear" type="radio" name="options" id="option1" title="Registrar Tipo de Habitacion" href="<?= base_url() ?>configuracion/tipo_habitacion_crear">
                                        <span class="fa fa-plus"></span> Nuevo Tipo de Habitacion
                                    </label>
