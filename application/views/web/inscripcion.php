        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a class="text-secondary">Inscripcion</a></li>
                </ol>
            </nav>
        </div>
    </nav>
                ...
                <div class="card mb-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                <?= form_dropdown('tipo', $tipo, $curso->id_curso, array('class' => 'form-control browser-default custom-select text-secondary text-uppercase', 'id' => 'curso', 'name' => 'curso')); ?>
