            ...
            <div class="col-lg-10">
                <div class="card mb-8">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="_persona_id" id="_persona_id" value="<?= $reserva->cliente_reserva; ?>" />
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                <?= form_dropdown('tipo', $tipo, "", array('class' => 'form-control browser-default custom-select text-secondary text-uppercase', 'id' => 'terapia', 'name' => 'terapia')); ?>
