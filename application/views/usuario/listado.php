        ...
        <div class="col-md-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title">
                <i class="fas fa-list mt-2 mr-1"></i>
                Lista
              </h3>
              <div class="card-tools">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  ...
                  <label class="btn btn-sm btn-light">
                    <input class="crear" type="radio" name="options" id="option1" title="Registrar Categoria" href="<?= base_url() ?>usuario/crear"><span class="fa fa-plus"></span> Nuevo Usuario
                  </label>
            ...
            <div class="card-body">
              <form class="ocform form-inline" method="POST">
