...
$(document).ready(function () {
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}clientes/cliente_crear/{id}' title="Editar Cliente" class="btn btn-warning btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}clientes/cliente_eliminar/{id}'title="Eliminar Cliente" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
