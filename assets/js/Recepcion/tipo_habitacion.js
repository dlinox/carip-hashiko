...
$(document).ready(function () {
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}configuracion/tipo_habitacion_crear/{id}' title="Editar habitacion" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}configuracion/tipo_habitacion_eliminar/{id}'title="Eliminar habitacion" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
