...
$(document).ready(function () {
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}configuracion/usuario_crear/{id}' title="Editar Usuario" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}configuracion/usuario_eliminar/{id}'title="Eliminar Usuario" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
