...
$(document).ready(function () {
   ...
   //  $('#rango').myDateRangePicker();
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}curso/preinscripcion_crear/{id}' title="Editar preinscripcion" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}curso/preinscripcion_eliminar/{id}'title="Eliminar preinscripcion" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
