    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (imagen2 == null) {
                ...
                $('#btnwhatsapp2').html("<a class='mt-2 btn btn-rounded btn-success' href='https://wa.me/+51999978644/?text=%0A%20%20%20%20%20%20%20%20%20%20VENTA DE PRODUCTO%20%20%20%20%20%20%20%20%20%0A+---------------------------------------+%0A%20%20%20NOMBRE:%20%20%20" + data.nombre_producto + "%0A%20%20%20PRESENTACION:%20%20%20" + data.presentacion2_producto + "' target='_blank'" + " > Comprar por Whatsapp</a > ");
