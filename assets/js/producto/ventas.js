...
$(document).ready(function () {
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}producto/venta_info/{id}' title="Detalles de la Venta" class="btn btn-primary btn-sm editar"><i class="fa fa-eye"></i></a>
        <a href='{baseurl}producto/venta_eliminar/{id}'title="Eliminar Venta" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
